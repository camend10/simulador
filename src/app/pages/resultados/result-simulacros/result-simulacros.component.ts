...
import { ResultadoService } from '../../../services/service.index';
import { EMPTY, catchError } from 'rxjs';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-result-simulacros',
  templateUrl: './result-simulacros.component.html',
  styles: ``
})
export class ResultSimulacrosComponent implements OnInit {
  ...
  cargarSimulacros() {
    ...
    this._resultadoService.cargarSimulacros()
      .pipe(
        catchError(error => {
          Swal.fire({
            title: "Error!",
